...
describe('startWebServer', () => {
  ...
  it('serves the static shell from GET /', async () => {
    ...
    expect(body).toContain('<button id="sendButton" class="send-button" type="submit" aria-label="Send message" title="Send message"><span class="send-button-icon" aria-hidden="true">↑</span></button>')
  ...
  it('serves refined Web UI interaction code from GET /static/app.js', async () => {
    ...
    expect(body).toContain("icon.textContent = isSending ? '■' : '↑'")
